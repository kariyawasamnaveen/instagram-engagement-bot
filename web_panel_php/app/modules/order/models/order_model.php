...
class order_model extends MY_Model
{
    ...
    public $tb_main;
    public $tb_ig_accounts;
    public $filter_accepted;
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            ...
            $this->db->select('o.id, o.ids, o.runs, o.service_id, o.status, o.charge, o.link, o.quantity, o.start_counter, o.changed, o.remains, o.created, o.custom_tags, o.delivery_speed');
    ...
    public function check_account_inventory($params = [])
    {
        ...
        if (isset($params['tag_filter']) && $params['tag_filter'] != '' && !in_array($params['tag_filter'], ['all', 'male', 'female'])) {
            $this->db->like('interest_tags', $params['tag_filter']);
        }
