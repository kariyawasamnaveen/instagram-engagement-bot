...
class staffs_activity_model extends MY_Model 
{
    ...
    public function __construct()
    {
        ...
        $this->field_search_accepted = app_config('config')['search']['staffs_activity'];
    }
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            $this->db->select('sl.id, sl.ids, sl.uid, sl.ip, sl.country, sl.event, sl.created,  sl.detail');
            $this->db->select('s.first_name, s.last_name, s.email');
            $this->db->from($this->tb_main . " sl");
            $this->db->join($this->tb_staffs." s", "s.id = sl.uid", 'left');
            //Search
