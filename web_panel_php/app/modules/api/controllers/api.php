...
class api extends My_UserController
{
    ...
    private function add($params)
    {
        ...
        $follows_username = (isset($params["follows_username"])) ? strip_tags(urldecode($params["follows_username"])) : '';
        ...
        $data = [
            ...
            "follows_speed" => (isset($params["follows_speed"])) ? strip_tags(urldecode($params["follows_speed"])) : '',
            "changed" => NOW,
            "created" => NOW,
        ];
