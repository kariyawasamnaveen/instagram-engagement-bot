    ...
    <ul class="nav navbar-menu align-items-center order-1 order-lg-2">
      ...
      <li class="nav-item dropdown">
        <a href="#" data-toggle="dropdown" class="nav-link d-flex align-items-center py-0 px-lg-0 px-2 text-color">
          <span class="ml-2 d-none d-lg-block leading-none">
            ...
            <?php if (current_logged_user()->membership_status == 1 && current_logged_user()->membership_level == 'pro') : ?>
              <span class="badge ml-1" style="background: linear-gradient(45deg, #FFD700, #FFA500); color: #000; font-weight: 700; font-size: 10px; padding: 2px 5px; border-radius: 4px;">PRO</span>
            <?php endif; ?>
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
          ...
          <a class="dropdown-item" href="<?php echo cn('membership'); ?>">
            <i class="icon fe fe-star dropdown-icon" style="color: #FFD700;"></i>
            <?= (current_logged_user()->membership_status == 1 && current_logged_user()->membership_level == 'pro') ? 'Membership' : 'Become a Pro' ?>
          </a>
