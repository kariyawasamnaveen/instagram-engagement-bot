...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="<?php echo BASE; ?>themes/nico/assets/css/app-dashboard.css?v=3.6" rel="stylesheet">
    <style>
      ...
      /* BULLETPROOF PREMIUM GOLD TAP HIGHLIGHT & ACTIVE FEEDBACK */
      .app-bottom-nav,
      .app-nav-item,
      .app-nav-item *,
      a.app-nav-item,
      a.app-nav-item:hover,
      a.app-nav-item:active,
      a.app-nav-item:focus {
          -webkit-tap-highlight-color: rgba(212, 175, 55, 0.25) !important; /* Premium Gold touch highlight */
      ...
      /* PREVENT ALL HOVER/ACTIVE/FOCUS BLUE FALLBACK */
      a.app-nav-item,
      a.app-nav-item:hover,
      a.app-nav-item:focus,
      a.app-nav-item:visited {
          color: #71717a !important; /* Neutral grey, no blue! */
      ...
      a.app-nav-item svg,
      a.app-nav-item:hover svg,
      a.app-nav-item:focus svg {
          fill: #71717a !important; /* SVG neutral, no blue! */
          transition: fill 0.15s ease !important;
      }

      /* Beautiful Premium Gold active tap feedback */
      a.app-nav-item:active {
          color: #D4AF37 !important; /* Turns Gold when clicked */
          background-color: rgba(212, 175, 55, 0.15) !important; /* Soft Gold rounded pill background on tap */
          border-radius: 12px !important;
          text-decoration: none !important;
      }
      a.app-nav-item:active svg {
          fill: #D4AF37 !important; /* Icon turns Gold when clicked */
      }

      /* Keep active item always Gold */
      a.app-nav-item.active,
      a.app-nav-item.active:hover,
      a.app-nav-item.active:focus,
      a.app-nav-item.active:active {
          color: #D4AF37 !important; /* Active gold, no blue! */
          text-decoration: none !important;
          background: transparent !important;
          background-color: transparent !important;
      }
      a.app-nav-item.active svg,
      a.app-nav-item.active:hover svg,
      a.app-nav-item.active:focus svg,
      a.app-nav-item.active:active svg {
          fill: #D4AF37 !important; /* SVG active gold, no blue! */
      }
    </style>
  ...
  <body class="theme-<?php echo $theme_name; ?> app-dashboard-active">
      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5 premium-fade-in-up">
          <div class="container">
            ...
            ?>
            <?php if (segment(1) != 'statistics' && segment(1) != 'new_order' && segment(1) != 'order' && segment(1) != 'subscriptions' && segment(1) != 'membership' && segment(1) != 'profile'): ?>
    ...
    <!-- general JS -->
    <script src="<?php echo BASE; ?>assets/js/process.js?v=3.4"></script>
    ...
    <div class="app-bottom-nav">
        ...
        <a href="<?=cn('membership')?>" class="app-nav-item <?=(segment(1)=='membership')?'active':''?>">
