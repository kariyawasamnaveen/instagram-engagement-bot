  ...
  <div class="container">
    <div class="d-flex">
      ...
      <div class="d-flex order-lg-2 ml-auto my-auto search-box">
        ...
        ?>
        <div class="notifcation d-none d-lg-block">
        ...
        <div class="dropdown">
            ...
            <span class="ml-2 d-none d-lg-block">
              <span class="text-default text-white">
                ...
                <?php if (current_logged_user()->membership_status == 1 && current_logged_user()->membership_level == 'pro') : ?>
                  <span class="badge ml-1" style="background: linear-gradient(45deg, #FFD700, #FFA500); color: #000; font-weight: 700; font-size: 10px; padding: 1px 4px; border-radius: 3px; position: relative; top: -1px;">PRO</span>
                <?php endif; ?>
              </span>
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
            ...
            <a class="dropdown-item" href="<?=cn('membership')?>">
              <i class="dropdown-icon fe fe-star" style="color: #FFD700;"></i> <?= (current_logged_user()->membership_status == 1 && current_logged_user()->membership_level == 'pro') ? 'Membership' : 'Become a Pro' ?>
            </a>
      ...
      <div class="d-lg-none ml-auto my-auto d-flex align-items-center">
        <div class="dropdown">
           <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
             <span class="avatar avatar-sm" style="background-image: url(<?=BASE?>assets/images/user-avatar.png); width: 32px; height: 32px;"></span>
           </a>
           <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
             <a class="dropdown-item" href="<?=cn('profile')?>">
               <i class="dropdown-icon fe fe-user"></i> <?=lang("Profile")?>
...
?>
<div class="header collapse d-none d-lg-flex p-0" id="headerMenuCollapse">
  <div class="container">
