...
$route['cron/automation'] = 'cron/cron/automation';
$route['cron/run'] = 'cron/cron/automation';
$route['cron/work'] = 'cron/cron/automation';
...
$route[$GLOBALS['ADMIN_URL_PREFIX']] = 'admin/login/login';
...
$route[$GLOBALS['ADMIN_URL_PREFIX'] . '/logout'] = 'admin/login/logout';
